...
public class PlaceAutocompleteAdapter extends ArrayAdapter<AutocompletePrediction> implements Filterable {
    ...
    public PlaceAutocompleteAdapter(Context context, GoogleApiClient googleApiClient, LatLngBounds bounds, AutocompleteFilter filter) {
        super(context, R.layout.row_places_suggestion);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View row = mLayoutInflater.inflate(R.layout.row_places_suggestion, null);
        ...
        TextView textView1 = (TextView) row.findViewById(R.id.txtPrimary);
        TextView textView2 = (TextView) row.findViewById(R.id.txtSecondary);
